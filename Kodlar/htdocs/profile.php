...
<head>
    ...
    <body>
            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        ...
                        <?php
                        if ($_SESSION["KULLANICI_AD"]) 
                        {
                        ?>
                            <?php echo $_SESSION["KULLANICI_AD"]; ?>
                        <?php
                        } 
        ...
        <?php
        $username = $_SESSION["KULLANICI_AD"]; 
        echo "<br><br><br><p id='username' >@$username</p>" ?>
        ...
        echo "<strong><p id='name'>$name</p></strong>" ?> 
        ...
        <hr>
            <form id="share" method="POST" action="blog.php" enctype="multipart/form-data">
                <span id="text"><strong> Bir şeyler paylaşın</strong></span>
                    <br>
                    <div>
                    <input type="text" id="box" placeholder="Şehir Adı" name="title" >
                    </div>
